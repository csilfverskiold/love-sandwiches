...
def validate_data(values):
    ...
    or if their aren't exactly six values.
    """
    try:
...
def update_surplus_worksheet(data):
    """
    Update surplus worksheet, add new row with data list provided.
    """
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock and calculate the surplus of each item type.
